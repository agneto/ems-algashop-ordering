...
class OrderMarkAsReadyTest {
    ...
    void givenPaidOrder_whenMarkAsReady_shouldUpdateStatusAndTimestamp() {
        Order order = com.algaworks.algashop.ordering.domain.model.order.OrderTestDataBuilder.anOrder().status(OrderStatus.PAID).build();
    ...
    void givenDraftOrder_whenMarkAsReady_shouldThrowExceptionAndNotChangeState() {
        Order order = com.algaworks.algashop.ordering.domain.model.order.OrderTestDataBuilder.anOrder().status(OrderStatus.DRAFT).build();
    ...
    void givenPlacedOrder_whenMarkAsReady_shouldThrowExceptionAndNotChangeState() {
        Order order = com.algaworks.algashop.ordering.domain.model.order.OrderTestDataBuilder.anOrder().status(OrderStatus.PLACED).build();
