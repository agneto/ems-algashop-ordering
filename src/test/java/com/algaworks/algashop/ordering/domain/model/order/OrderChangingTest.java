...
public class OrderChangingTest {
    ...
    void givenDraftOrder_whenChangeIsPerformed_shouldNotThrowException() {
        Order draftOrder = com.algaworks.algashop.ordering.domain.model.order.OrderTestDataBuilder.anOrder().build();

        Product product = ProductTestDataBuilder.aProductAltMousePad().build();
        Quantity quantity = new Quantity(2);
        Billing billing = com.algaworks.algashop.ordering.domain.model.order.OrderTestDataBuilder.aBilling();
    ...
    void givenPlacedOrder_whenChangeBillingIsCalled_shouldThrowOrderCannotBeEditedException() {
        Order placedOrder = com.algaworks.algashop.ordering.domain.model.order.OrderTestDataBuilder.anOrder().status(OrderStatus.PLACED).build();
        Billing billing = com.algaworks.algashop.ordering.domain.model.order.OrderTestDataBuilder.aBilling();
